  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Error al crear entrenamiento');
      }

      router.push('/admin/workouts');
    } catch (error) {
      console.error('Error:', error);
      setError(error instanceof Error ? error.message : 'Error al crear entrenamiento');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Crea un nuevo entrenamiento para la plataforma
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Completa los datos del nuevo entrenamiento
          </CardDescription>
        </CardHeader>
        <CardContent>
