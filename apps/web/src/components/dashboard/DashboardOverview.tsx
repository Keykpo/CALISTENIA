...
import { migrateToUnifiedHexagon, calculateUnifiedOverallLevel, getUnifiedLevelProgress, type UnifiedFitnessLevel } from '@/lib/unified-hexagon-system';
...
export default function DashboardOverview({ userData, onRefresh }: DashboardOverviewProps) {
  const [localHexagon, setLocalHexagon] = useState<any>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Missions and Quick Actions Grid */}
